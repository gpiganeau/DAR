	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				fixed4 finalColor;
				float3 temp_output_2_0_g724 = (AHF_FogColor).rgb;
				...
				#endif
				float3 temp_output_893_0 = staticSwitch1_g724;
				float3 temp_output_2_0_g723 = (AHF_DirectionalColor).rgb;
				float3 gammaToLinear3_g723 = GammaToLinearSpace( temp_output_2_0_g723 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g723 = temp_output_2_0_g723;
				#else
				float3 staticSwitch1_g723 = gammaToLinear3_g723;
				#endif
				...
				float3 lerpResult135 = lerp( temp_output_893_0 , staticSwitch1_g723 , DirectionalMask134);
				...
				float temp_output_7_0_g699 = AHF_FogHeightEnd;
				half FogHeightMask193 = saturate( ( ( (WorldPosition144).y - temp_output_7_0_g699 ) / ( AHF_FogHeightStart - temp_output_7_0_g699 ) ) );
				float temp_output_115_0 = ( FogDistanceMask186 * FogHeightMask193 );
				float simplePerlin3D15_g702 = snoise( ( ( WorldPosition144 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
				float temp_output_7_0_g705 = -1.0;
				...
				float lerpResult20_g702 = lerp( 1.0 , ( ( simplePerlin3D15_g702 - temp_output_7_0_g705 ) / ( 1.0 - temp_output_7_0_g705 ) ) , ( NoiseDistanceMask353 * AHF_NoiseIntensity * AHF_NoiseModeBlend ));
				half NoiseSimplex3D234 = lerpResult20_g702;
				...
				float temp_output_6_0_g714 = RawDepth209;
				#ifdef UNITY_REVERSED_Z
				float staticSwitch11_g714 = temp_output_6_0_g714;
				#else
				float staticSwitch11_g714 = ( 1.0 - temp_output_6_0_g714 );
				#endif
				half SkyboxMask83 = ( 1.0 - ceil( staticSwitch11_g714 ) );
...
/*ASEBEGIN
Version=17101
1927;29;1906;1014;3678.873;5171.973;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;904;-3072,-768;Inherit;False;Fog Height;-1;;698;61a3ca69e0854664d87b5233acc9cbae;0;1;8;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;908;-3008,384;Inherit;False;Fog Noise;-1;;702;fe51dc291bbca2147aa47de2202288d1;0;2;22;FLOAT3;0,0,0;False;23;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;900;-3072,-2304;Inherit;False;Get Skybox Mask From Depth;-1;;714;e5ec8c46f59f8d945ae6dea4b02558d2;0;1;6;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;894;-2880,-3904;Inherit;False;Handle Color Space;-1;;723;f6f44b689bae74d47a0885dbe3018c48;0;1;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;893;-2880,-4096;Inherit;False;Handle Color Space;-1;;724;f6f44b689bae74d47a0885dbe3018c48;0;1;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=1C0465C80891B9A387CE53C6F9DE2F5E32E0A46D