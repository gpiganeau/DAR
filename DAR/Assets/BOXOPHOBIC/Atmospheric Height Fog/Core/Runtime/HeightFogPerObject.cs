...
public class HeightFogPerObject : MonoBehaviour
{
    ...
    [StyledMessage("Info", "Please note that the Height Fog Per Object option is EXPERIMENTAL and will not work for all transparent objects. Available in Play mode only. Please read the documentation for more!", 5, 5)]
